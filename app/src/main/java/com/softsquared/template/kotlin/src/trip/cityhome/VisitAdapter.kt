...
import com.softsquared.template.kotlin.databinding.ItemTourBinding
import com.softsquared.template.kotlin.src.trip.TripActivity

private lateinit var binding: ItemTourBinding

class VisitAdapter(private val context: Context, private val tourList: ArrayList<Tour>) : BaseAdapter() {
